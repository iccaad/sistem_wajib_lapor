...
3.  **Manajemen Peserta (`/admin/participants`):**
    ...
    *Desktop View (md+):* Kolom Nama & NIK (bold & subtext), Admi(header 'Admin'), Masa Pengawasan, Jumlah Periode, Kuota per Periode, Periode Ini (Visual Progress Bar kehadiran), dan Aksi (Ikon Detail dan Edit saja).
