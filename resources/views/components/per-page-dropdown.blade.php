{{--
    ...
    @param string $class – Optional tailwind classes for wrapper div
--}}
<div class="{{ $class ?? 'flex items-center justify-end mb-4' }}">
    <form method="GET" action="{{ route($route) }}" class="inline-flex items-center gap-2 text-sm text-gray-500">
        ...
        <select name="per_page"
                ...
                class="appearance-none pl-3 pr-8 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-lg hover:border-gray-300 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 cursor-pointer">
