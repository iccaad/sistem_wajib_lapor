...
@section('breadcrumb', 'Buat akun admin baru')
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-base font-semibold text-gray-800">Tambah Akun Admin Baru</h2>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.accounts.store') }}" class="p-6 space-y-5">
            @csrf
