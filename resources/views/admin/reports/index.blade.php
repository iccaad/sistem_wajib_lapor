...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5 no-print">
    ...
    <button onclick="window.print()"
            class="inline-flex items-center gap-2 px-4 py-2 bg-brand-primary hover:bg-brand-secondary text-white text-sm font-bold rounded-lg shadow-lg shadow-black/10 transition transform active:scale-95">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-4 text-right no-print">
                            <a href="{{ route('admin.reports.show', $p) }}"
                               class="text-xs font-bold text-brand-accent hover:text-brand-secondary transition">
                                Lihat Detail →
                            </a>
                        </td>
                    </tr>
