        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center gap-2 text-sm text-gray-500">
                    <span>Tampilkan</span>
                    <form method="GET" action="{{ route('admin.violation-types.index') }}" class="inline">
                        ...
                        <select name="per_page"
                            ...
                            <option value="5" {{ $violationTypes->perPage() == 5 ? 'selected' : '' }}>5</option>
                            <option value="10" {{ $violationTypes->perPage() == 10 ? 'selected' : '' }}>10</option>
                            <option value="15" {{ $violationTypes->perPage() == 15 ? 'selected' : '' }}>15</option>
                            <option value="20" {{ $violationTypes->perPage() == 20 ? 'selected' : '' }}>20</option>
                        </select>
                    </form>
