    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.locations.index') }}" class="text-gray-400 hover:text-gray-600 transition">
        ...
        <form method="POST" action="{{ $formAction }}" class="p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="loc-name" class="block text-sm font-medium text-gray-700 mb-1">Nama Lokasi <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="loc-address" class="block text-sm font-medium text-gray-700 mb-1">Alamat</label>
                    <input type="text" id="loc-address" name="address"
                           value="{{ old('address', $location->address ?? '') }}"
                           class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 @error('address') border-red-400 @enderror">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">
                    Radius Deteksi: <span class="font-bold text-indigo-600" x-text="radius + 'm'"></span>
                </label>
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    <label class="block text-sm font-medium text-gray-700">Koordinat (klik peta untuk memilih)</label>
                    <button type="button" @click="useMyLocation()"
                            class="inline-flex items-center gap-1.5 text-xs font-medium text-indigo-600 hover:text-indigo-800 transition">
                ...
                <div x-show="hasCoords"
                     class="mt-2 flex gap-4 text-xs text-gray-500 font-mono">
                    <span>Lat: <span class="text-gray-800" x-text="lat"></span></span>
                    <span>Lng: <span class="text-gray-800" x-text="lng"></span></span>
                </div>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit"
                        ...
                        class="px-5 py-2 text-sm font-medium text-white rounded-lg shadow-sm transition">
